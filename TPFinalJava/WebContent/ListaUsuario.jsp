...
<title>Lista Usuarios</title>
  <!-- Bootstrap core CSS -->
    ...
    <%
    	LinkedList<Usuario> listaUsu = new LogicUsuario().getAll();
...
<div class="container">
  ...
  <table class="table table-fixed table-condensed">
    ...
    <%for(Usuario usu : listaUsu ){ %>
      <tr>
        <td><%=usu.getCodUser() %> </td>
        <td><%=usu.getApellido() %></td>
        <td><%=usu.getNombre() %></td>
        <td><%=usu.getTipo() %></td>
        
        <td><a class="bg-primary text-white" href="UsuarioServlet?accion=editar&codUser=<%=usu.getCodUser()%>"><button type="button" class="btn btn-primary">Editar</button></a></td>
        <td><a class="bg-danger text-white" href="UsuarioServlet?accion=eliminar&codUser=<%=usu.getCodUser()%>"><button type="button" class="btn btn-danger">Eliminar</button></a></td>
      </tr>
      <%} %>
